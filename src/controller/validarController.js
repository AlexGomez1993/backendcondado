...
const validarMail = async (req, res) => {
    ...
    <table style="width:100%; max-width:600px; margin:auto; font-family:Arial, sans-serif; border:1px solid #e0e0e0; border-collapse:collapse; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
      <tr style="background-color:#e6e6edff; color:#76287dff;">
        <td style="width:30%;padding:10px; text-align:left; vertical-align:middle;">
          <img src="cid:logo" alt="Condado Logo" style="height:35px; margin-right:10px;" />
        </td>
      ...
      <tr>
        <td colspan="2" style="padding:20px;">
          ...
          <p style="font-size:24px; font-weight:bold; color:#76287dff; text-align:center; margin:20px 0;">
            ${codigo}
          </p>
...
`;
        ...
        const mailOptions = {
            ...
            attachments: [
                {
                    filename: 'logocondado.png',
                    path: path.join(__dirname, '../../public/logocondado.png'),
                    cid: 'logo'
                }
            ]
        };
